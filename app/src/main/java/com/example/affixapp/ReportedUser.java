...
import com.example.affixapp.ui.ReportedUser2;
...
public class ReportedUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reported_user);

        // Initialize lineChart by finding it using findViewById()
        lineChart = findViewById(R.id.chart3);//chart3 is id of chart of weekly reported users

        // Initialize button using findViewById()
        btnBack = findViewById(R.id.backButton2);

        btnMonthly=findViewById(R.id.showMonthly1);

        // Initialize FirebaseFirestore instance
        db = FirebaseFirestore.getInstance();

        Description description=new Description();
        description.setText("Weekly Reported Users Report");
        ...
        btnMonthly.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                Intent intent=new Intent(ReportedUser.this, ReportedUser2.class);
    ...
    private void countNewUsers() {
        ...
        for (int i = 0; i < 7; i++) {
            ...
            db.collection("reportedUsers")
                    .whereGreaterThanOrEqualTo("createdTimestamp", startDate)
                    .whereLessThan("createdTimestamp", endDate)
                    .get()
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            ...
                            Log.e("ReportedUser", "Error fetching users:", task.getException());
                        }
                    });
        }
    }
    ...
    private void updateGraph(int[] newUsersCount) {
        ...
        LineDataSet dataSet = new LineDataSet(entries, "Reported Users");
