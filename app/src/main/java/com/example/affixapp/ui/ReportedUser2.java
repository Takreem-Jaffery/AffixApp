...
public class ReportedUser2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reported_user2);
        ...
        lineChart = findViewById(R.id.chart4);// chart4 is the montlhy chart for ReportedUsers

        Description description = new Description();
        description.setText("Monthly Reported Users Report");
...
//This will take you to the NewUser Page(Weekly report page)
        ...
        btnHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(ReportedUser2.this,ReportActivity.class);
            ...
            db.collection("reportedUsers")
                    ...
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            ...
                            Log.e("ReportedUser2", "Error fetching users:", task.getException());
                        }
                    });
        }
    }
