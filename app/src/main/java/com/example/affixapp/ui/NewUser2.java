...
public class NewUser2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        description.setText("Monthly New Users Report");
...
//This will take you to the NewUser Page(Weekly report page)
        ...
        btnHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(NewUser2.this,ReportActivity.class);
            ...
            db.collection("users")
                    ...
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            ...
                            Log.e("NewUser", "Error fetching users:", task.getException());
                        }
                    });
        }
    }
